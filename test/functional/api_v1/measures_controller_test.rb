...
module ApiV1
  class MeasuresControllerTest < ActionController::TestCase
    ...
    setup do
      ...
      cms347_fixtures = File.join("cql_measures", "CMS347v1"), File.join("records", "CMS347v1"), File.join("health_data_standards_svs_value_sets", "CMS347v1")
    ...
    test "should calculate result in json as default" do
      VCR.use_cassette("backend_calculation_json_as_default") do
        ...
        assert_equal 0, json["59b6b2275cc975edb3000041"]["PopulationCriteria1"]["IPP"]
        assert_equal 0, json["59b6b2275cc975edb3000041"]["PopulationCriteria1"]["NUMER"]
      end
    end
  ...
  #       assert_equal 'CMS347v1.xlsx', filename
  #       # temp = Temp.new(["test", ".xlsx"])
  #       temp = File.new("GATOR.xlsx","w")
  #       temp.write(response.body)
  #       temp.rewind
  #       doc = Roo::Spreadsheet.open(temp.path)

  #       assert_equal "\nKEY\n", doc.sheet("KEY").row(1)[0]
  #       assert_equal 0.0, doc.sheet("1 - Population Criteria Section").row(3)[0]
  #     end
