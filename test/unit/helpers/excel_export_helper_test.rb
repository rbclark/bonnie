...
class ExcelExportHelperTest < ActionView::TestCase
  ...
  setup do
    ...
    @backend_results = {}
    @backend_results["5a58e9b6942c6d4bb26bb2f6"] = backend_results["5b3fb7b10ba2300e3bfa9859"] # Visit_1ED
    @backend_results["5a593ff0942c6d0773593dff"] = backend_results["5b3fb7b10ba2300e3bfa985f"] # Visit_1Excl_2Ed
    @backend_results["5a593d66942c6d0773593d97"] = backend_results["5b3fb7b10ba2300e3bfa9867"] # Visits_2ED
    @backend_results["5a5940ba942c6d0c717eeece"] = backend_results["5b3fb7b10ba2300e3bfa986f"] # Visits_2Excl_2ED
